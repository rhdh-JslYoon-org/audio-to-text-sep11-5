...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-sep11-5](https://github.com/rhdh-JslYoon-org/audio-to-text-sep11-5)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-sep11-5-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-sep11-5-gitops)

# **Usage**

To access the audio-to-text-sep11-5 application that was deployed using the Software Template, complete the following instructions:
